...
export class OArbGovernanceAdapter {
    id = 'oarb-governance';
    ...
    canParse(artifact) {
        ...
        return (lowercasePath.includes('069-production-readiness') ||
    ...
    parse(input) {
        ...
        if (lowercaseFilename.includes('delivery-ledger') || lowercaseFilename.includes('delivery_ledger')) {
            ...
            const has090PhaseExit = artifactIndex.some(art => art.role === 'phase-exit-source' && art.featureNumber === 90);
