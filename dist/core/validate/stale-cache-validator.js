 ...
 */
export function validateStaleCache(existingSnapshot, freshArtifacts, context) {
    const errors = [];
    const warnings = [];
    ...
    const snapshotArtifacts = existingSnapshot.artifacts;
    const snapshotArtMap = new Map();
